...
export const servicesMenu: MegaMenuConfig = {
      ...
      items: [
  {
    ...
    description: 'Build production-ready AI systems in weeks with a focused AI team.',
    icon: Bot,
    badge: 'NEW',
  },
  {
    label: 'GenAI Consulting & Workshops',
    href: '/services/genai-consulting',
    description: 'Strategy, workshops, roadmaps',
    icon: Sparkles,
  },
  {
    label: 'AI PoC & MVP Development',
    href: '/services/ai-poc-mvp',
    description: 'Validate AI ideas fast',
    icon: Rocket,
  },
  {
    label: 'AI Agents',
    href: '/services/ai-agents',
    description: 'Autonomous LLM-powered workflows',
    icon: Bot,
  },
  {
    label: 'Machine Learning Solutions',
    href: '/services/machine-learning',
    description: 'Predictive models, ML pipelines',
    icon: Database,
  },
  {
    label: 'Intelligent Data Solutions',
    href: '/services/intelligent-data',
    description: 'AI-driven process automation',
    icon: Zap,
  },
  {
    label: 'AI Integration & Deployment',
    href: '/services/ai-integration',
    description: 'Pipelines, integration & deployment',
    icon: Puzzle,
  },
  {
    label: 'MLOps & AI Infrastructure',
    href: '/services/mlops',
    description: 'Model ops, deployment & monitoring',
    icon: Layers,
  },
  {
    label: 'Data Governance & Business Intelligence',
    href: '/services/data-governance',
    description: 'BI dashboards & data quality',
    icon: BarChart3,
  },
  {
    label: 'Data-Driven Insights',
    href: '/services/data-insights',
    description: 'Analytics, forecasting & reporting',
    icon: TrendingUp,
  },
  {
    label: 'AI Strategy Consulting',
    href: '/services/ai-strategy',
    description: 'Strategy, workshops & AI roadmap',
    icon: Compass,
  },
],
    },
