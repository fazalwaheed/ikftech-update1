...
export default function CTASection() {
  return (
    <section className="relative overflow-hidden section-pad bg-[#8B1E2D]">
      <div className="grain-overlay" />

      <div
        aria-hidden="true"
        className="absolute -bottom-24 left-1/2 h-72 w-72 -translate-x-1/2 rounded-full bg-white/10 blur-3xl animate-blob"
      />
      ...
      <div className="container-x relative flex flex-col items-center gap-6 text-center">
        ...
        <Reveal delay={0.3}>
          <div className="mt-2 flex flex-col gap-4 sm:flex-row">
            <Link
              href="/contact"
              className="btn-primary bg-white text-[#8B1E2D] hover:bg-black hover:text-white"
            >
              Book a free call
            ...
            <Link
              href="/case-studies"
              className="btn-outline border-white/30 bg-transparent text-white hover:border-white hover:bg-white hover:text-[#8B1E2D]"
            >
              See our work
            </Link>
          </div>
